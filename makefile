...
build/network_test: src/cache.c src/server.c
	gcc src/server.c src/cache.c src/testing.c src/lru.c /usr/local/lib/libevhtp.a $(CFLAGS) -L. -levent -levent_core -o build/network_test
